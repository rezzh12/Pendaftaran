	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('images/bg-01.jpg');">
            ...
            <span class="login100-form-logo">
                        ...
                        <div class="row mb-0" style="padding-left:150px">
                    ...
                    <br>
				  <p class="text-center">Have Account?<a href="{{ route('login') }}" class="ml-4 text-sm text-gray-700 dark:text-gray-500 underline">Login</a></p>
			</div>
			</div>
		</div>
	</div>
