...
@section('content')
    <div class="container-fluid">
        <div class="card card-default">
            <div class="card-header">{{ __('Pengelolaan Data Berita') }}</div>
            <div class="card-body">
                    ...
                    @php $no=1; @endphp
                        @foreach ($berita as $row)
                            <tr>
                                ...
                                <td> @if ($row->foto!== null)
                                        <img src="{{ asset('storage/berita/' . $row->foto) }}" width="100px" height="100px" />
                                    @else
                ...
                <div class="modal-body">
                    <form method="post" action="{{ route('admin.berita.submit') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="isi" id="isi" cols="60" rows="5"></textarea>
                        </div>
                        <div class="form-group">
                ...
                <div class="modal-body">
                    ...
                    @csrf
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="isi" id="edit-isi" cols="60" rows="5"></textarea>
                        </div>
                        <div class="form-group">
                            <label for="edit-foto">Foto</label>
                            <input type="file" class="form-control" name="foto" id="editfoto" required />
                        </div>
